...
// JSONParser.cpp
//
// $Id: //poco/Main/Web/src/JSONParser.cpp#7 $
//
// Library: Web
...
const int JSONParser::_asciiClass[] = {
...
const int JSONParser::_stateTransitionTable[NR_STATES][NR_CLASSES] = {
/*
                 white                                      1-9                                   ABCDF  etc
...
void JSONParser::parseBufferPopBackChar()
{
...
int JSONParser::decodeUnicodeChar()
{
	int i;
	unsigned uc = 0;
	char* p;
...
void JSONParser::parseBuffer()
{
	if (_pHandler)
	{
		...
		if (type != JSONEntity::JSON_T_NONE)
		{
			...
			JSONEntity value(_type, val);
			if (_pHandler) _pHandler->handle(value);
		}
	}
