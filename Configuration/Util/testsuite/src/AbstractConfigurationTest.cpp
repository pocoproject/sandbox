...
void AbstractConfigurationTest::testGetInt()
{
	...
	assert (pConf->getInt("prop4.int5", 100) == 100);
}
...
void AbstractConfigurationTest::testGetInt64()
{
	...
	assert (pConf->getInt64("prop4.int3") == 42);
	assert (pConf->getInt64("prop4.int4") == -42);
	assert (pConf->getInt64("prop4.hex1") == 0x1f);
	...
	assert (pConf->getInt64("prop4.int3", 100) == 42);
	assert (pConf->getInt64("prop4.int4", 100) == -42);
	assert (pConf->getInt64("prop4.int5", 100) == 100);
...
void AbstractConfigurationTest::testSetInt64()
{
	...
	pConf->setInt64("set.int3", 42);
	pConf->setInt64("set.int4", -100);
	assert (pConf->getInt64("set.int3") == 42);
	assert (pConf->getInt64("set.int4") == -100);
#endif //defined(POCO_HAVE_INT64)
}
...
AbstractConfiguration* AbstractConfigurationTest::createConfiguration() const
{
	...
	pConfig->setString("prop4.int3", "42");
	pConfig->setString("prop4.int4", "-42");
	pConfig->setString("prop4.hex", "0x1f");
	pConfig->setString("prop4.hex1", "0x1f");
...
CppUnit::Test* AbstractConfigurationTest::suite()
{
	...
	CppUnit_addTest(pSuite, AbstractConfigurationTest, testGetInt64);
