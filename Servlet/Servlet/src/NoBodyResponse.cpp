...
NoBodyResponse::NoBodyResponse(HttpServletResponse& r):
	_resp(r), 
	_pNoBody(new ServletOutputStream(_nullOutputStream))
{
}
...
ServletOutputStream& NoBodyResponse::getOutputStream()
{ 
	//hijack the real output stream and give out the wrapper
	_resp.getOutputStream();
	return *_pNoBody; 
}
