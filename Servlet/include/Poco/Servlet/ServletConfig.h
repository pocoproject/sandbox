...
//
// Definition of the ServletConfig class.
//
...
#ifndef Servlet_ServletConfig_INCLUDED
#define Servlet_ServletConfig_INCLUDED
...
class Servlet_API ServletConfig 
{
 public:	
	ServletConfig();
	...
	virtual const std::string& getServletName() const = 0;
...
#endif // Servlet_ServletConfig_INCLUDED
