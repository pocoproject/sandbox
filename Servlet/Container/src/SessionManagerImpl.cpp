...
SessionManagerImpl::SessionManagerImpl(long maxInactiveInterval,
	HttpSessionListener* pListener,
	long maxSessions,
	long purgeInterval):
SessionManager(maxInactiveInterval, pListener, maxSessions, purgeInterval)
{
}
