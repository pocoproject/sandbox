...
#ifndef IO_ChannelConfig_INCLUDED
#define IO_ChannelConfig_INCLUDED
...
class IO_API ChannelConfig: public Poco::RefCountedObject
{
public:
	enum ChannelType
	{
...
#endif // IO_ChannelConfig_INCLUDED
