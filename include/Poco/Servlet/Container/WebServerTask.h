...
#ifndef Container_WebServerTask_INCLUDED
#define Container_WebServerTask_INCLUDED
...
{
public:
	WebServerTask(const std::string& base, Poco::Servlet::Ex::HttpServletDispatcher& dispatcher);
...
#endif //Container_WebServerTask_INCLUDED
