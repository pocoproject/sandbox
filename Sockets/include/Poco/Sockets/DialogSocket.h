...
#ifndef Sockets_DialogSocket_INCLUDED
#define Sockets_DialogSocket_INCLUDED
...
class Sockets_API DialogSocket: public StreamSocket
...
#endif // Sockets_DialogSocket_INCLUDED
