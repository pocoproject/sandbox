...
#ifndef Sockets_SocketImpl_INCLUDED
#define Sockets_SocketImpl_INCLUDED
...
class Sockets_API SocketImpl: public Poco::RefCountedObject
...
public:
	...
	void getOption(int level, int option, Address& value);
		/// Returns the value of the socket option 
		/// specified by level and option.
...
#endif // Sockets_SocketImpl_INCLUDED
