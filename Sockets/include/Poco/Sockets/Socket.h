...
#ifndef Sockets_Socket_INCLUDED
#define Sockets_Socket_INCLUDED
...
public:
	...
	void setOption(int level, int option, const Address& value);
		/// Sets the socket option specified by level and option
		/// to the given time value.
	...
	void getOption(int level, int option, Address& value) const;
		/// Returns the value of the socket option 
		/// specified by level and option.
...
inline void Socket::setOption(int level, int option, const Address& value)
{
	_pImpl->setOption(level, option, value);
}
...
inline void Socket::getOption(int level, int option, Address& value) const
{
	_pImpl->getOption(level, option, value);
}
