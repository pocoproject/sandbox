...
#ifndef Sockets_RawSocket_INCLUDED
#define Sockets_RawSocket_INCLUDED
...
class Sockets_API RawSocket: public Socket
...
public:
	...
	RawSocket(Address::Family family, int proto = IPPROTO_RAW);
...
#endif // Sockets_RawSocket_INCLUDED
