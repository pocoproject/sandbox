...
// DNS.h
//
// $Id: //poco/Main/Sockets/include/Poco/Sockets/DNS.h#3 $
//
// Library: Sockets
// Package: Address
// Module:  DNS
...
#ifndef Sockets_DNS_INCLUDED
#define Sockets_DNS_INCLUDED
...
public:
	...
	static HostEntry hostByAddress(const Address& address);
		/// Returns a HostEntry object containing the DNS information
	...
	static Address resolveOne(const std::string& address);
