...
#ifndef Sockets_SocketAddress_INCLUDED
#define Sockets_SocketAddress_INCLUDED
...
class Sockets_API SocketAddress
...
public:
	...
	SocketAddress(const Address& host, Poco::UInt16 port);
...
protected:
	void init(const Address& host, Poco::UInt16 port = 0);
...
#endif // Sockets_SocketAddress_INCLUDED
