...
// NetworkInterface.h
//
// $Id: //poco/1.3/Sockets/include/Poco/Sockets/NetworkInterface.h#6 $
//
// Library: Sockets
// Package: Sockets
...
#ifndef Sockets_NetworkInterface_INCLUDED
#define Sockets_NetworkInterface_INCLUDED
...
class Sockets_API NetworkInterface
...
public:
	...
	static NetworkInterface forAddress(const Address& address);
...
protected:
	NetworkInterface(const std::string& name, const std::string& displayName, const Address& address, int index = -1);
		/// Creates the NetworkInterface.

	NetworkInterface(const std::string& name, const std::string& displayName, const Address& address, const Address& subnetMask, const Address& broadcastAddress, int index = -1);
		/// Creates the NetworkInterface.
		
	NetworkInterface(const std::string& name, const Address& address, int index = -1);
		/// Creates the NetworkInterface.

	NetworkInterface(const std::string& name, const Address& address, const Address& subnetMask, const Address& broadcastAddress, int index = -1);
		/// Creates the NetworkInterface.
		
	Address interfaceNameToAddress(const std::string& interfaceName) const;
		/// Determines the Address bound to the interface with the given name.
...
#endif // Sockets_NetworkInterface_INCLUDED
