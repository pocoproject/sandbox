...
#ifndef Sockets_SocketStream_INCLUDED
#define Sockets_SocketStream_INCLUDED
...
class Sockets_API SocketStreamBuf: public Poco::BufferedBidirectionalStreamBuf
...
class Sockets_API SocketIOS: public virtual std::ios
...
class Sockets_API SocketOutputStream: public SocketIOS, public std::ostream
...
class Sockets_API SocketInputStream: public SocketIOS, public std::istream
...
class Sockets_API SocketStream: public SocketIOS, public std::iostream
...
#endif // Sockets_SocketStream_INCLUDED
