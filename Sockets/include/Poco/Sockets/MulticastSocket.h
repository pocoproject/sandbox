...
#ifndef Sockets_MulticastSocket_INCLUDED
#define Sockets_MulticastSocket_INCLUDED
...
class Sockets_API MulticastSocket: public DatagramSocket
...
public:
	...
	MulticastSocket(Address::Family family);
	...
	void joinGroup(const Address& groupAddress);
		/// Joins the specified multicast group at the default interface.
		
	void joinGroup(const Address& groupAddress, const NetworkInterface& interface);
		/// Joins the specified multicast group at the given interface.
		
	void leaveGroup(const Address& groupAddress);
		/// Leaves the specified multicast group at the default interface.
		
	void leaveGroup(const Address& groupAddress, const NetworkInterface& interface);
...
#endif // Sockets_MulticastSocket_INCLUDED
