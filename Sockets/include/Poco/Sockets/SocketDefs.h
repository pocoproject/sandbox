...
#ifndef Sockets_SocketDefs_INCLUDED
#define Sockets_SocketDefs_INCLUDED
...
#	endif
#	if !defined(SUN_LEN)
#		define SUN_LEN(su) (offsetof(struct sockaddr_un, sun_path) + std::strlen((su)->sun_path) + 1)
#	endif
#	if !defined(UNIXSTR_PATH)
#		define UNIXSTR_PATH "/tmp/unix.str"
#	endif
#endif


#endif // Sockets_SocketDefs_INCLUDED
