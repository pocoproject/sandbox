...
#include "Poco/Sockets/MulticastSocket.h"
...
MulticastSocket::MulticastSocket(Address::Family family): DatagramSocket(family)
{
}
...
void MulticastSocket::joinGroup(const Address& groupAddress)
{
...
void MulticastSocket::joinGroup(const Address& groupAddress, const NetworkInterface& interface)
{
...
void MulticastSocket::leaveGroup(const Address& groupAddress)
{
	NetworkInterface intf;
...
void MulticastSocket::leaveGroup(const Address& groupAddress, const NetworkInterface& interface)
{
	if (groupAddress.af() == AF_INET)
	{
		struct ip_mreq mr;
