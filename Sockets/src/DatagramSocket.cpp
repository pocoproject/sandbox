...
// DatagramSocket.cpp
//
// $Id: //poco/svn/Net/src/DatagramSocket.cpp#2 $
//
// Library: Net
// Package: Sockets
...
#include "Poco/Sockets/DatagramSocketImpl.h"
...
DatagramSocket::DatagramSocket(Address::Family family):
	Socket(new DatagramSocketImpl(family))
{
}


DatagramSocket::DatagramSocket(const SocketAddress& address, bool reuseAddress): 
	Socket(new DatagramSocketImpl(
#ifdef POCO_OS_FAMILY_UNIX
		AF_LOCAL == address.af() ? Address::LOCAL : Address::IPv4
#endif		
		))
{
