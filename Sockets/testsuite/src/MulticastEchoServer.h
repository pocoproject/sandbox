...
public:
	...
	const Poco::Sockets::SocketAddress& group() const;
		/// Returns the group address where the server listens.
	
	const Poco::Sockets::NetworkInterface& interface() const;
		/// Returns the network interface for multicasting.
	
protected:	
	static Poco::Sockets::NetworkInterface findInterface();
		/// Finds an appropriate network interface for
		/// multicasting.
	
private:
	Poco::Sockets::MulticastSocket  _socket;
	Poco::Sockets::SocketAddress    _group;
	Poco::Sockets::NetworkInterface _if;
	Poco::Thread _thread;
	Poco::Event  _ready;
	bool         _stop;
};
