...
//
// $Id: //poco/Main/Zip/src/AutoDetectStream.cpp#3 $
//
// Library: Zip
// Package: Zip
...
AutoDetectStreamBuf::AutoDetectStreamBuf(std::istream& in, const std::string& pre, const std::string& post):
...
AutoDetectIOS::AutoDetectIOS(std::istream& istr, const std::string& pre, const std::string& post): _buf(istr, pre, post)
{
	poco_ios_init(&_buf);
}
...
AutoDetectInputStream::AutoDetectInputStream(std::istream& istr, const std::string& pre, const std::string& post): 
	AutoDetectIOS(istr, pre, post), 
	std::istream(&_buf)
{
}
