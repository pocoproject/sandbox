...
// Compress.h
//
// $Id: //poco/Main/Zip/include/Poco/Zip/Compress.h#3 $
//
// Library: Zip
// Package: Zip
// Module:  Compress
...
public:
	...
	Compress(std::ostream& out, bool seekableOut);
		/// seekableOut determines how we write the zip, setting it to tue is recommened for local files (smaller zip file),
