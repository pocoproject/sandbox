...
// AutoDetectStream.h
//
// $Id: //poco/Main/Zip/include/Poco/Zip/AutoDetectStream.h#2 $
//
// Library: Zip
// Package: Zip
...
{
public:
	AutoDetectStreamBuf(std::istream& in, const std::string& prefix, const std::string& postfix);
...
{
public:
	AutoDetectIOS(std::istream& istr, const std::string& prefix, const std::string& postfix);
...
{
public:
	AutoDetectInputStream(std::istream& istr, const std::string& prefix = std::string(), const std::string& postfix = std::string());
