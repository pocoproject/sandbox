...
#include "autoconfig.h"  //Used to auto determine platform and compiler.
#include <stddef.h>
...
***********************************************************************/
  ...
  /*If dll we need to export. Not for static library*/
  #if defined(_DLL) && defined(_NSPR_BUILD_)
  ...
  #else /* Else assume its an exe or we are building a static lib */
  ...
  #endif /* defined(_DLL) && defined(_NSPR_BUILD_)*/
