...
--    os.execute("premake --usetargetpath --with-samples --with-testsuite --clean --target vs6")
    os.execute("premake --usetargetpath --with-samples --with-testsuite --target vs2003")
    os.execute("premake --usetargetpath --with-samples --with-testsuite --target vs2005")
    os.execute("premake --usetargetpath --with-samples --with-testsuite --target vs2008")
    os.execute("premake --usetargetpath --with-samples --with-testsuite --target gnu")
    os.execute("premake --usetargetpath --with-samples --with-testsuite --target cb-gcc")
end
